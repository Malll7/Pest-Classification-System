...
class _ListScreenState extends State<ListScreen> {
  ...
  void initState() {
    ...
    _loadFavoriteList(); // Load favorites on initialization
  }
    ...
    switch (pestName) {
      case 'Aphid':
        Navigator.push(context,
            MaterialPageRoute(builder: (context) => const AphidList()));
        break;
      case 'Armyworm':
        Navigator.push(context,
            MaterialPageRoute(builder: (context) => const ArmywormList()));
        break;
      case 'Beetle':
        Navigator.push(context,
            MaterialPageRoute(builder: (context) => const BeetleList()));
        break;
      case 'Mite':
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => const MiteList()));
        break;
      case 'Sawfly':
        Navigator.push(context,
            MaterialPageRoute(builder: (context) => const SawflyList()));
        break;
      case 'Stem Borer':
        Navigator.push(context,
            MaterialPageRoute(builder: (context) => const StemBorerList()));
        break;
      case 'Stemfly':
        Navigator.push(context,
            MaterialPageRoute(builder: (context) => const StemflyList()));
        break;
      default:
        break;
    }
