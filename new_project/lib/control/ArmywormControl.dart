...
class ArmywormControl extends StatelessWidget {
  const ArmywormControl({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Armyworm Control Measure', style: TextStyle(fontSize: 20, letterSpacing: 1)),
