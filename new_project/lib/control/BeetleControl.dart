...
class BeetleControl extends StatelessWidget {
  const BeetleControl({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Beetle Control Measure', style: TextStyle(fontSize: 20, letterSpacing: 1)),
