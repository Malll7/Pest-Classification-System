...
class StemBorerControl extends StatelessWidget {
  const StemBorerControl({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Stem Borer Control Measure', style: TextStyle(fontSize: 20, letterSpacing: 1)),
