...
class StemflyControl extends StatelessWidget {
  const StemflyControl({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Stemfly Control Measure', style: TextStyle(fontSize: 20, letterSpacing: 1)),
