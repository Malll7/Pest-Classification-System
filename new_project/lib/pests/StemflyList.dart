...
class StemflyList extends StatelessWidget {
  const StemflyList({super.key});

  // Function to fetch brown marmorated stink bugs data from Firestore
  Future<Map<String, dynamic>?> _fetchStemflyData() async {
    try {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Stemfly Information', style: TextStyle(fontSize: 20, letterSpacing: 1)),
      ...
      body: FutureBuilder<Map<String, dynamic>?>(
        ...
        builder: (BuildContext context,
          ...
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            Map<String, dynamic> stemflyData = snapshot.data!;
            String description =
                stemflyData['description'] ?? 'No description available';
            String habitat =
                stemflyData['habitat'] ?? 'No habitat information available';
            String impact =
                stemflyData['impact'] ?? 'No impact information available';
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        image: const DecorationImage(
          image: AssetImage('assets/stemfly.jpg'),
          fit: BoxFit.cover,
        ),
      ),
    );
