...
class SawflyList extends StatelessWidget {
  const SawflyList({super.key});

  // Function to fetch brown marmorated stink bugs data from Firestore
  Future<Map<String, dynamic>?> _fetchSawflyData() async {
    try {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Sawfly Information', style: TextStyle(fontSize: 20, letterSpacing: 1)),
      ...
      body: FutureBuilder<Map<String, dynamic>?>(
        ...
        builder: (BuildContext context,
          ...
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            Map<String, dynamic> sawflyData = snapshot.data!;
            String description =
                sawflyData['description'] ?? 'No description available';
            String habitat =
                sawflyData['habitat'] ?? 'No habitat information available';
            String impact =
                sawflyData['impact'] ?? 'No impact information available';
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        image: const DecorationImage(
          image: AssetImage('assets/sawfly.jpg'),
          fit: BoxFit.cover,
        ),
      ),
    );
