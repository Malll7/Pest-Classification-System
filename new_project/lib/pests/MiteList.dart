...
class MiteList extends StatelessWidget {
  const MiteList({super.key});

  // Function to fetch brown marmorated stink bugs data from Firestore
  Future<Map<String, dynamic>?> _fetchMiteData() async {
    try {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Mite Information', style: TextStyle(fontSize: 20, letterSpacing: 1)),
      ...
      body: FutureBuilder<Map<String, dynamic>?>(
        ...
        builder: (BuildContext context,
          ...
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            Map<String, dynamic> miteData = snapshot.data!;
            String description =
                miteData['description'] ?? 'No description available';
            String habitat =
                miteData['habitat'] ?? 'No habitat information available';
            String impact =
                miteData['impact'] ?? 'No impact information available';
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        image: const DecorationImage(
          image: AssetImage('assets/mite.jpg'),
          fit: BoxFit.cover,
        ),
      ),
    );
